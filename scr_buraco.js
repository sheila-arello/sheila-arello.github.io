function createButtonsMain (nameButton, idButton){
...
createButtonsMain ('1a Rodada', 'btn-rodada1');
createButtonsMain ('2a Rodada', 'btn-rodada2');
createButtonsMain ('3a Rodada', 'btn-rodada3');
createButtonsMain ('4a Rodada', 'btn-rodada4');
createButtonsMain ('SOMA', 'btn-soma');
createButtonsMain ('Nova Partida', 'btn-reinicio');
...
const btnRodada1 = document.getElementById('btn-rodada1');
btnRodada1.addEventListener('click', function(){
  numRodada = 1;
...
const btnRodada2 = document.getElementById('btn-rodada2');
btnRodada2.addEventListener('click', function(){
  if (numRodada !== 1){
    alert('Você ainda não iniciou a primeira rodada!');
  } else {
    numRodada = 2;
    document.getElementById('rounds2').style.display = 'block';
  }
...
const btnRodada3 = document.getElementById('btn-rodada3');
btnRodada3.addEventListener('click', function(){
  if (numRodada !== 2){
    alert('Você ainda não iniciou a segunda rodada!');
  } else {
    numRodada = 3;
    document.getElementById('rounds3').style.display = 'block';
  }
...
const btnRodada4 = document.getElementById('btn-rodada4');
btnRodada4.addEventListener('click', function(){
  if (numRodada !== 3){
    alert('Você ainda não iniciou a terceira rodada!');
  } else {
    numRodada = 4;
    document.getElementById('rounds4').style.display = 'block';
  }
